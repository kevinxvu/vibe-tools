...
AI tools gọi tới LLM provider bạn đã cấu hình. Xem [Tự Host](#tự-host) để thiết lập.
...
Thay `OPENAI_API_KEY`, `OPENAI_BASE_URL`, `LLM_TEXT_MODEL`, `LLM_AUDIO_MODEL` bằng API key và Base URL thực tế trước khi expose app.
